...
// ========== ТАБЫ, БУРГЕР, КОПИРОВАНИЕ, ПОИСК ПО ПРАВИЛАМ ==========
...
let originalRulesHtml = rulesContainer.innerHTML; // сохраняем исходный HTML
...
clearBtn.addEventListener('click', () => { searchInput.value = ''; rulesContainer.innerHTML = originalRulesHtml; });
searchInput.addEventListener('keypress', (e) => { if (e.key === 'Enter') highlightText(searchInput.value); });